...
/** @type {string} */
const CACHE_VERSION = '1768023529|16234366061';
/** @type {string} */
const CACHE_PREFIX = 'overlay3.0-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'overlay3.0.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["overlay3.0.html","overlay3.0.js","overlay3.0.offline.html","overlay3.0.icon.png","overlay3.0.apple-touch-icon.png","overlay3.0.audio.worklet.js","overlay3.0.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["overlay3.0.wasm","overlay3.0.pck"];
